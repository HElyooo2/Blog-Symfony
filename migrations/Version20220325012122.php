 ...
 */
final class Version20220325012122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tag ADD COLUMN description CLOB DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_5ACE3AF04B89032C ON post_tag (post_id)');
        $this->addSql('CREATE INDEX IDX_5ACE3AF0BAD26311 ON post_tag (tag_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__tag AS SELECT id, name, categ FROM tag');
        $this->addSql('DROP TABLE tag');
        $this->addSql('CREATE TABLE tag (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, categ VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO tag (id, name, categ) SELECT id, name, categ FROM __temp__tag');
